function draw_vertical_wall(wall_obj) {
	...
	var src_height = wall_obj.sprite_height - 2 * non_stretchable_part_height;
	var desired_height = wall_obj.sprite_height * image_yscale - 2 * non_stretchable_part_height;
...
function draw_horizontal_wall(wall_obj) {
	...
	var src_width = wall_obj.sprite_width - 2 * non_stretchable_part_width;
	var desired_width = wall_obj.sprite_width * image_xscale - 2 * non_stretchable_part_width;
